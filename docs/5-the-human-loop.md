...
[`/wiki-init`](../.claude/skills/understand/wiki-init/SKILL.md) stands up a
...
point. From the human loop's side, [`/intent`](../.claude/skills/intent/SKILL.md)
...
[`/evaluate-pr`](../.claude/skills/evaluate/evaluate-pr/SKILL.md) produces two
...
[`/evaluate-sessions`](../.claude/skills/evaluate/evaluate-sessions/SKILL.md) is
