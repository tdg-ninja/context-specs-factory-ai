...
[`/expert-sdd-creator`](../.claude/skills/specs/expert-sdd-creator/SKILL.md), and
...
When you run [`/spec-planning`](../.claude/skills/specs/spec-planning/SKILL.md),
...
[`compute_tiers.py`](../.claude/skills/dev/implement-mainspec/scripts/compute_tiers.py)
topologically sorts it to find which slices can run concurrently.

## Validation — consensus before code

A spec is a plan, and plans have blind spots. [`/spec-validate`](../.claude/skills/specs/spec-validate/SKILL.md)
...
[`/implement-slice`](../.claude/skills/dev/implement-slice/SKILL.md) implements
...
[`/implement-mainspec`](../.claude/skills/dev/implement-mainspec/SKILL.md)
