...
- [`poll-and-dispatch.sh`](../.claude/skills/harness/harness-init/assets/poll-and-dispatch.sh) — the dispatcher: the canonical realization of these invariants in code.
