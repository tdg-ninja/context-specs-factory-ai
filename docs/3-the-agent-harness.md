...
> You describe a feature to [`/intent`](../.claude/skills/intent/SKILL.md) and
...
[`/intent`](../.claude/skills/intent/SKILL.md) turns an open-ended idea into two
coupled artifacts:
...
([`poll-and-dispatch.sh`](../.claude/skills/harness/harness-init/assets/poll-and-dispatch.sh))
...
[`/harness-init`](../.claude/skills/harness/harness-init/SKILL.md) — which stands
